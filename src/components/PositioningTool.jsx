        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <textarea
                    className="w-full p-2 border border-gray-300 rounded-md"
                    rows="2"
                    placeholder="e.g., Low cost, simplicity, familiarity"
                    value={item.val2 || ''}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <textarea
                    className="w-full p-2 border border-gray-300 rounded-md"
                    rows="2"
                    placeholder="e.g., Time-consuming, prone to errors"
                    value={item.val3 || ''}
            ...
            <div>
                ...
                <textarea
                    className="w-full p-2 border border-gray-300 rounded-md"
                    rows="2"
                    placeholder="Evidence: company names, quotes"
                    value={item.val4 || ''}
...
const RemovableTriple = ({ index, item, onUpdate, onRemove }) => (
    <div className="space-y-3 p-4 border border-gray-200 rounded-lg bg-gray-50">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Value/Proof</label>
                <input
                    type="text"
                    className="w-full p-2 border border-gray-300 rounded-md"
                ...
                fileInput.onchange = (event) => {
                    ...
                    reader.onload = (e) => {
                        try {
                            ...
                            // Map market category
                            if (content.marketCategory !== undefined && content.marketCategory !== null) {
                                updates['market-context'] = content.marketCategory;
                            }

                            // Map category name
                            if (content.categoryName !== undefined && content.categoryName !== null) {
