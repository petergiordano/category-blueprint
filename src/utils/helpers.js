...
export const serverLog = async (level, message, error = null) => {
    // Temporarily disabled to prevent infinite loops
    return;
};

export const ensureAlternativesStructure = (alternatives) => {
...
export const flattenSegmentData = (organizedSegmentData) => {
...
export const generateDeepResearchPrompt = (companyData) => {
  try {
